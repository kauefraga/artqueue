...
import { FinishedCommissionsPage } from './pages/finished-commissions.tsx';
import { NotFoundPage } from './pages/not-found.tsx';
import { PendingCommissionsPage } from './pages/pending-commissions.tsx';
...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <FormContextProvider>
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<PendingCommissionsPage />} />
          <Route path="/finished" element={<FinishedCommissionsPage />} />
