...
import { PendingCommissionsActions } from '../components/pending-commissions/actions';
import { PendingCommissionsNav } from '../components/pending-commissions/nav';
...
export function PendingCommissionsPage() {
  ...
  return (
    <>
      <Header
        nav={<PendingCommissionsNav />}
        actions={
          <PendingCommissionsActions onClearCommissions={clearPendingCommissions} />
        }
      />
      ...
      <CommissionsContainer>
        ...
        <button
          ...
          className="w-full border-1 rounded-lg p-2 border-b-2 border-e-2 transition-all hover:bg-amber-400 hover:cursor-pointer hover:rounded-none dark:hover:text-black dark:border-white"
        >
          Adicionar
        </button>
