...
export const CommissionSchema = z.object({
  ...
  price: z.coerce.number().int().positive({ message: 'Preço deve ser um número positivo' }),
  paymentStatus: z.enum(['pagou', 'não pagou'], { message: 'Status de pagamento deve ser "pagou" ou "não pagou"' }),
  stage: z.enum(['esboço', 'finalizado'], { message: 'Estágio deve ser "esboço" ou "finalizado"' }),
